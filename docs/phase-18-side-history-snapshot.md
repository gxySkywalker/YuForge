...
新增包：`src/main/java/com/yuforge/snapshot/`
...
```text
~/.yuforge/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dyuforge.snapshot.enabled=false
-Dyuforge.snapshot.max=50
-Dyuforge.snapshot.excludes=...
```
