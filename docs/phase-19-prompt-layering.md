...
```text
src/main/java/com/yuforge/prompt/
...
2. 用户级覆盖：`~/.yuforge/prompts/...`
3. 项目级覆盖：`.yuforge/prompts/...`

例如：

```text
~/.yuforge/prompts/base.md
~/.yuforge/prompts/modes/agent.md
.yuforge/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.yuforge/prompts/...`
- [x] 支持项目级覆盖 `.yuforge/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
