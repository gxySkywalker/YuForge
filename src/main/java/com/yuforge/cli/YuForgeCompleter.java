...
import com.yuforge.mcp.mention.AtMentionCompleter;
...
final class YuForgeCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    YuForgeCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
