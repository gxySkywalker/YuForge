...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("yuforge.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("YUFORGE_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".yuforge", "runtime").toString();
        }
