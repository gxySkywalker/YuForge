...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(YuForgeConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("YuForge v16.0.0");
    ...
    public YuForgeConfig getConfig() {
        return config;
    }
}
