...
import com.yuforge.tui.config.TuiConfigPanel;
 ...
 *
 * <p>TUI 触发条件：
 * - {@code YUFORGE_RENDERER=lanterna|tui} 环境变量或 {@code -Dyuforge.renderer=lanterna|tui}
 * - 兼容旧入口：{@code YUFORGE_TUI=true} 环境变量或 {@code -Dyuforge.tui=true} 系统属性
 *
 * <p>即使显式启用，以下情况仍降级：
...
public final class TuiBootstrap {
    ...
    private static final String TUI_ENV = "YUFORGE_TUI";
    private static final String TUI_PROPERTY = "yuforge.tui";
    private static final String RENDERER_ENV = "YUFORGE_RENDERER";
    private static final String RENDERER_PROPERTY = "yuforge.renderer";
     ...
     */
    public static void launch(YuForgeConfig config,
                              LlmClient llmClient,
                              Agent reactAgent,
