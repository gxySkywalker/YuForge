...
import com.yuforge.tui.history.ConversationSnapshot;
import com.yuforge.tui.pane.CenterPane;
import com.yuforge.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final YuForgeConfig config;
    ...
    public TuiSessionController(YuForgeConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "yuforge-tui-agent-runner");
