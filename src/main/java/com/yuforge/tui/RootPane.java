...
import com.yuforge.tui.pane.FileTreePane;
import com.yuforge.tui.pane.InputBar;
...
public class RootPane extends Panel {
     ...
     */
    public RootPane(YuForgeConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.yuforge/history/。");
            return true;
        }
