...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("yuforge.memory.dir");
        System.setProperty("yuforge.memory.dir", tempDir.toString());
        try {
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("yuforge.memory.dir");
            } else {
                System.setProperty("yuforge.memory.dir", oldMemoryDir);
            }
        }
    }
